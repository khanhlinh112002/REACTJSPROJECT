...
function SearchBus(props) {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      ...
      .then(
        (result) => {
          alert("Yêu cầu đã được duyệt, mời bạn kiểm tra email để biết thông tin chi tiết");
        },
        (error) => {
  ...
  return (
    <main id="content">
          ...
          <div className="col-3">
            <div className="section-heading">
              ...
              <h2 className="section-title">
                ĐỐI VỚI CHÚNG TÔI CHẤT LƯỢNG LÀ DANH DỰ
              </h2>
      ...
      {/*End of Introduction*/}
      <form
        className="row text-center clearfix w3-container w3-card-4 scrollto"
        id="datve"
        ref={form}
        onSubmit={sendEmail}
      >
        <div className="section-heading">
          <h2 className="section-title">
            Vui lòng đặt vé cho chuyến đi của bạn
          </h2>
        </div>
        <div>
          <input
        ...
        <div className="w3-half">
          ...
          <select className="w3-select w3-border" name="option1">
        ...
        <div className="w3-half">
          ...
          <select className="w3-select w3-border" name="option2">
            <option value disabled selected>
              Điểm đến
            </option>
            {Record.map((record) => {
        ...
        <div className="w3-half">
          ...
          <input type="text" name="useName" className="w3-input w3-border" />
        </div>
        <div className="w3-half">
          <label>Số điện thoại</label>
          <input className="w3-input w3-border" name="usephone" type="text" />
        </div>
        <br></br>
        <br></br>
      ...
      >
        <div className="row clearfix">
          <div className="section-heading">
            <h3>Nhận xét</h3>
            <h2 className="section-title">
              Khách hàng nói về chúng tôi như thê nào
            </h2>
          </div>
          {/*User Testimonial*/}
